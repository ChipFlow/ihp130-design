...
from .ips.i2c import I2CPeripheral
...
class MySoC(wiring.Component):
    ...
    def elaborate(self, platform):
        ...
        m.submodules.i2c = i2c = I2CPeripheral(self.ports.i2c)
        csr_decoder.add(i2c.csr_bus, name="i2c", addr=self.csr_i2c_base  - self.csr_base)
